...
class OCULUSINTERACTION_API UIsdkConditionalGroupAll : public UIsdkConditionalGroup
{
 ...
 public:
  ...
  /**
   * @brief Iterate through stored Conditionals and return true if all stored conditionals are true
   * @return bool Whether or not all stored Conditionals are currently true
   */
