...
class OCULUSINTERACTION_API UIsdkConditionalGroupAny : public UIsdkConditionalGroup
{
 ...
 public:
  ...
  /**
   * @brief Iterate through stored Conditionals and return true if any stored conditional is true
   * @return bool Whether or at least one stored Conditional is currently true
   */
